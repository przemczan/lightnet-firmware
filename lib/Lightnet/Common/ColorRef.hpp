...
struct __attribute__((__packed__)) ColorRef {
    uint8_t kind;
    union {
        struct __attribute__((__packed__)) { uint8_t r, g, b; }     rgb;
        struct __attribute__((__packed__)) { uint8_t pos, _0, _1; } palette;
        struct __attribute__((__packed__)) { uint8_t slot, _0, _1; } useColor;
        uint8_t raw[3];
    };
};
...
static inline ColorRef ColorRef_palette(uint8_t pos) {
    ...
    c.palette.pos = pos; c.palette._0 = 0; c.palette._1 = 0;
    return c;
}
...
static inline ColorRef ColorRef_useColor(uint8_t slot) {
    ...
    c.useColor.slot = slot; c.useColor._0 = 0; c.useColor._1 = 0;
    return c;
}
