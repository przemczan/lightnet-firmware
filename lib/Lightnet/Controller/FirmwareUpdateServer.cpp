...
void FirmwareUpdateServer::handleUploadBody(AsyncWebServerRequest *request,
...
void FirmwareUpdateServer::handleStatusRequest(AsyncWebServerRequest *request)
{
    ...
    if (s.hasError) {
        ...
        switch (s.state) {
            ...
            case PanelFlasher::State::WAIT_BL:   stateStr = "connecting";  break;
            case PanelFlasher::State::FLASHING:  stateStr = "flashing";    break;
            case PanelFlasher::State::VERIFY:    stateStr = "verifying";   break;
            case PanelFlasher::State::NEXT_PANEL:stateStr = "flashing";    break;
            case PanelFlasher::State::DONE:      stateStr = "done";        break;
