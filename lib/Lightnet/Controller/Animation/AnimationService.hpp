...
struct SceneResult {
    ...
    bool ok() const { return err == SceneError::None; }

    static SceneResult success() {
        SceneResult r; r.err = SceneError::None; r.msg[0] = '\0'; return r;
    }
    static SceneResult error(SceneError e, const char* message) {
        SceneResult r; r.err = e;
...
public:
    ...
    SceneResult playOneShot(const char* body, size_t len,
