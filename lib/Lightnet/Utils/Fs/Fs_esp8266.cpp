...
namespace Lightnet {
    bool   Fs::begin()                                     { return LittleFS.begin(); }
    ...
    bool   FsDir::next()           { return _dir.next(); }
    String FsDir::fileName() const { return _dir.fileName(); }
    size_t FsDir::fileSize() const { return _dir.fileSize(); }
}  // namespace Lightnet
